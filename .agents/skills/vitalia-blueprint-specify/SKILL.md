---
name: vitalia-blueprint-specify
description: >
  SHIM: Comando descontinuado. Redireciona para /vitalia-spec-specify --preset=educational
---
<!-- SKILL.md | Vitalia Kit 0.4.0 — gerado por install-project.sh -->
<!-- Source: /home/andre/.vitalia/kit/extensions/blueprint-specify.toml -->

# Vitalia: blueprint-specify

Ao acionar este comando:

1. Leia o arquivo `~/.vitalia/kit/extensions/blueprint-specify.toml`
