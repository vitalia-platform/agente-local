---
name: vitalia-blueprint-plan
description: >
  SHIM: Comando descontinuado. Redireciona para /vitalia-spec-plan
---
<!-- SKILL.md | Vitalia Kit 0.4.0 — gerado por install-project.sh -->
<!-- Source: /home/andre/.vitalia/kit/extensions/blueprint-plan.toml -->

# Vitalia: blueprint-plan

Ao acionar este comando:

1. Leia o arquivo `~/.vitalia/kit/extensions/blueprint-plan.toml`
